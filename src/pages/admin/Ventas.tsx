            ...
            <tbody className="divide-y divide-gray-50">
              {sales.map((s, i) => (
                <motion.tr key={s.id} initial={{opacity:0,y:4}} animate={{opacity:1,y:0}} transition={{delay:i*0.02}}
                  ...
                  <td className="px-4 py-3 text-gray-900 font-medium">{s.client_name}</td>
                  ...
                  <td className="px-4 py-3">
                    <span className={cn('px-2.5 py-0.5 rounded-full text-[11px] font-semibold border', statusColor[s.payment_status])}>
